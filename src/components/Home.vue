<template>
    ...
    <secttion class="section-banner-one" id="section-banner-one">
        <div class="container">
            <div class="list-banner">
                <div class="row">
                    <div class="banner">
    ...
    prevEl: '.btn-prev',
                        ...
                        <swiper-slide class="card">
                            <div class="card-image">
                                <img src="https://product.hstatic.net/1000351433/product/5677_e0ce5f2d8cbe47248975bcfc810a3f3d_grande.jpg"
                                    alt="" class="card-img" />
                                <div class="overlay-image">
                                    <img src="https://product.hstatic.net/1000351433/product/7__15__b82550fcffd34a87a2aa79bea4c71e90_grande.jpg"
    ...
    <section class="section-end-of-year" id="section-end-of-year">
        <div class="container">
            <div class="s-title">
                <h2>
                    <a href="/collections/sale-end-season">
                        END OF SEASON
                    </a>
                </h2>
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <div class="s-content">
                <div class="card">
                    <div class="card-image-wrapper">
                        <div class="card-image">
                            <img src="https://product.hstatic.net/1000351433/product/1_0bac43dfa7894d1b9816c8e8d4f07d76_large.jpg"
                                alt="" class="card-img">
                            <img src="https://product.hstatic.net/1000351433/product/7__8__a2f1af83b063441ca9222ffa361f54b2_grande.jpg"
                    ...
                    <div class="card-description">
                        <div class="description-name">
                            <h4>
                                <a title="ACID CORDUROY" href="/products/acid-corduroy">ACID CORDUROY</a>
                            </h4>
                        </div>
...
#section-bar-code.section-bar-code {
    position: relative;
    width: 100%;
    height: 250px;
    background-color: transparent;
...
#section-scroll-one.section-scroll-one {
...
#section-banner-one.section-banner-one {
    display: block;
    width: 100%;
    height: 980px;
    position: relative;
...
#section-end-of-year.section-end-of-year {
    width: 100%;
    height: 1080px;
    margin-bottom: 50px;
