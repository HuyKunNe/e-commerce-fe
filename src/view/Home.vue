...
export default {
    ...
    setup() {
        ...
        const sideBar = globals.categories;
        return {
            swiper,
    ...
    mounted() {
        api.get(`collections?path_like=best-seller`).then((res) => {
            this.products = res.data[0].products;
        });
        api.get(`collections?path_like=sale-end-season`).then((res) => {
            this.productCollection = res.data[0].products;
        });
        if (this.$store.state.showLoginToast === 1) {
            setTimeout(() => {
                this.showToast({
            ...
            .swiper {
                ...
                .card {
                    ...
                    .card-image-wrapper {
                        ...
                        .card-image:hover .overlay_loader {
                            opacity: 1;
                            cursor: pointer;
                        }
                    }
